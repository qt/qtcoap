...
class QtCoAP(ConanFile):
    ...
    description = "CoAP is a protocol for IoT devices, and machine to machine communication. " \
    ...
    def package_info(self):
        self.cpp_info.libs = ["Qt6Coap"]  # used for the actual library filename, Ordered list with the library names
